...
public class detailkontak extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.detailkontak);
        ...
        firebaseFirestore.collection("Contacts").whereEqualTo("telepon", teleponId)
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if(task.isSuccessful()){
                    ...
                    Toast.makeText(detailkontak.this, "Error getting documents", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
        ...
        if(filePath != null){
            ...
            uploadTask.addOnProgressListener(new OnProgressListener<UploadTask.TaskSnapshot>() {
                ...
                public void onFailure(@NonNull Exception e) {
                    progressBar.setVisibility(View.INVISIBLE);
                    Toast.makeText(detailkontak.this, "Failed " + e.getMessage(), Toast.LENGTH_LONG).show();
                }
            });
        }else{
            SimpanData(TextNama.getText().toString(),
